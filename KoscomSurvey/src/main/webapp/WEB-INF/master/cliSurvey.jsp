	  ...
	  <!-- Modal -->
	    ...
	    <div class="container" style=" padding-left: 40px; padding-right: 40px;">
	      <div class="header">
	        <nav>
	          <ul class="nav nav-pills pull-right">
	            <li role="presentation" style="margin-top: 20px;margin-bottom:20px;"><a href="/cateEdit/">Edit</a></li>
	            <li role="presentation" style="margin-top: 20px;margin-bottom:20px;" class="active"><a href="/survey/">Survey</a></li>
	          </ul>
	        </nav>
		    <h4 class="text-muted">
	      ...
	      <div class="row marketing">
	        <div class="col-lg">
			  <form method="post" class="quesList-form" id="formname1" <%-- action="${pageContext.request.contextPath}/survey/surveyAdd" --%>>
	        	<div class = "jumbotron" style = "text-align:center; display: table;width: 100%;">
	        	 <input type="hidden" id="cateNo" name="cateNo" value="${cateVo.cateNo}">
		 		 <h2 id="cateName" name="cateName" style="margin-top: 0px; margin-bottom: 4%;color: inherit;" value="${cateVo.cateName}">${cateVo.cateName}</h2>
		         <p><select class="form-control" id = "selectCompany" name = "companyNo" style="width: 250px; margin: 0 auto;">
		         ...
		         <p><input type="text" id="manager" name = "manager" placeholder="&nbsp&nbsp&nbsp담당자" style = "width: 250px;height:38px;font-size:1.5rem;"></p>
				</div>
				<div class = "svPart">
			  ...
			  <c:forEach var = "vo" items = "${selectQlist}"  varStatus="status">
	          	...
	          	<c:set var="count" value="${count + 1}"/>
			          ...
			          <input type="hidden" id="quesNo" name="quesNo[${index}]" value="${vo.quesNo}">
			          <input type="hidden" id="quesName" name="quesName[${index}]" value="${vo.quesName}">
			          <p><textarea class="form-control" type="text" id="answer" name="answer[${index}]" style = "width: 90%; height:100px;" ></textarea>
			        </div>
			      <br>
	          		<c:set var="index" value="${index + 1}"/>
		       	</c:if>
